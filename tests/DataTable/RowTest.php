...
class RowTest extends TestCase
{
  ...
  public function testCells()
  {
    $id = 'row-1';
    $cell1Text = 'Cell 1';
    $cell1 = Cell::i($cell1Text);

    $cell2Text = 'Cell 2';
    $cell2Color = 'primary';
    $cell2 = Cell::i($cell2Text)->color($cell2Color);

    $row = Row::i($id)->cells([$cell1, $cell2]);
    $this->assertEquals([
      'id'      => $id,
      'cells'   => [
        ['text' => $cell1Text],
        ['text' => $cell2Text, 'color' => $cell2Color],
      ],
      'actions' => [],
    ], $row->toArray());
  }
  ...
  public function testActions()
  {
    ...
    $row = Row::i($id)->actions([$action1, $action2]);
    $this->assertEquals([
      'id'      => $id,
      'cells'   => [],
      'actions' => [
